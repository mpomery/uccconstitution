...
\begin{enumerate}
	...
	\item To generally to carry out the policy of the Club; and
	\item To generally to carry out the instructions and decisions of the Committee.
\end{enumerate}
{\color{Cyan}NOTE:
...
\begin{enumerate}
	...
	\item To enerally to carry out the instructions of the Committee.
\end{enumerate}}
...
\begin{enumerate}
	...
	\item To generally to carry out the instructions of the Committee.
\end{enumerate}}
...
%%% Incorporations Act may change to remove this requirement
	...
	\item To generally to carry out the instructions and decisions of the Committee relating to the administration of the Club;
...
\begin{enumerate}
	...
	\item To generally to carry out the instructions of the Committee relating to the property and finances of the Club.
\end{enumerate}
