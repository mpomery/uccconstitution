...
(Amended on 4-Jun-1980, 16-Feb-1996, 23-Jan-1998, 6-Oct-1999, 16-Dec-2010, 8-Mar-2011 for incorporation, 13-Feb-2015, 21-Oct-2016, 14-Sep-2017, 18-Dec-2017, 30-Apr-2019, 15-Aug-2019)\\}
...
\section{Cancellation of Membership} \label{sec:mem_cancel}
\begin{enumerate}
	\item \label{item:mem_cancel:may_cancel} The Club may cancel the membership of any member of the Club, should that member have acted in a manner contrary to the best interests of the Club.
	\begin{enumerate}
		\item \label{item:mem_cancel:may_cancel:fairness} A committee meeting must be held at which the member or their representative must be given a reasonable opportunity to make written and oral submissions to the committee about their actions.
		\item The stipulation in \ref{sec:mem_cancel}\ref{item:mem_cancel:may_cancel:fairness} may be ignored by the committee in the case of the refusal by the member to:
		\begin{enumerate}
			\item Attempt to attend any committee meetings.
			\item Elect a representative.
		\end{enumerate}
	\end{enumerate}
...
\section{Dispute Resolution} \label{sec:dispute_resolution}
\begin{enumerate}
