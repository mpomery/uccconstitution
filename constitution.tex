...
\begin{enumerate}
	...
	\item co-ordinate and supervise the work of the {\color{red}Vice-President,} {\color{ForestGreen}Education Vice-President, Social Vice-President,} Secretary, Treasurer, and other officers of the Club subject to the authority of the Committee
...
\begin{enumerate}
	\item maintain an up to date register of the members of the Club and {\color{red}their postal or residential addresses} {\color{ForestGreen}the information required by the Act} and, upon the request of a member of the Club, make the register available for the inspection of the member
	\begin{enumerate}[1.]
...
The Committee may at any time, without the need for a Committee meeting, call a Special General Meeting of the Club by the written agreement of at least {\color{red}4} {\color{ForestGreen}five} Committee members, at least {\color{red}one} {\color{ForestGreen}two} of whom is a member of the Executive. This meeting must be notified by the Secretary as with all other General Meetings, or if the Secretary has resigned or is unavailable by any member of the Committee with the same notice requirements of the Secretary.\\
