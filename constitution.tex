...
\begin{enumerate}
	...
	{\color{red} \item Any members of the Club may hold a position of ordinary Committee member.}
	{\color{ForestGreen} \item Any members of the Club may hold a position of Ordinary Committee Member.}
...
\begin{enumerate}
	\item to assist in the President's duties;
	\item to ensure the club maintains an educational aspect;
	\item generally to carry out the instructions of the Committee.
\end{enumerate}}
...
\begin{enumerate}
	\item to assist in the President's duties;
	\item to ensure the club maintains a social aspect;
	\item generally to carry out the instructions of the Committee.
\end{enumerate}}
...
\begin{enumerate}
	{\color{red}\item to represent the interests of members of the Club who are in first year University or who have not previously been members of the Club.}
	{\color{ForestGreen}\item to represent the interests of members of the Club who are in first year University or who have not previously been members of the Club; and}
	{\color{ForestGreen}\item to assist the other Committee Members in the executions of their duties; and}
	{\color{ForestGreen}\item to bear any responsibilities that the Committee shall from time to time decide.}
\end{enumerate}
...
% is it worth removing things about incorporation? We've already done this
...
\subsection{Quorum}
{\color{red}The quorum of a General Meeting shall be fifteen ordinary members present in person.}\\
{\color{ForestGreen}The quorum of a General Meeting shall be twenty ordinary members present in person.}
\subsection{Rules of Debate}
...
\begin{enumerate}
	\item The Committee in a Meeting may make policy on any matter relating to the conduct of the affairs of the Club provided that policy is not inconsistent with or repugnant to this Constitution or the Act.
	\item Creation, modification, or removal of policy can occur at any meeting.
...
{\color{red}\section{Interim Measures}
