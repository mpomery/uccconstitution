...
\begin{enumerate}
	\item The President
	{\color{red}\item \st{Vice-President}}
...
\begin{enumerate}
	\item The President
	{\color{red}\item \st{The Vice-President}}
	{\color{ForestGreen}\item The Education Vice-President
	\item The Social Vice-President}
	\item The Secretary
	\item The Treasurer
	{\color{red}\item \st{Three Ordinary Committee Members}}
...
\begin{enumerate}
	...
	\begin{enumerate}[1.]
		...
		\end{enumerate}
	\item borrow money or incur overdrafts provided always that the total long term liabilities of the Club shall not exceed {\color{red}\st{one}} {\color{ForestGreen}two} hundred dollars, unless otherwise approved by a General Meeting
...
\subsection{Quorum}
The quorum for a meeting of the Committee shall be {\color{red}\st{four}} {\color{ForestGreen}five} members of the Committee at least {\color{red}\st{two}} {\color{ForestGreen}three} of which are members of the Executive.
...
\begin{enumerate}
	...
	\item co-ordinate and supervise the work of the {\color{red}\st{Vice-President,}} {\color{ForestGreen}Education Vice-President, Social Vice-President,} Secretary, Treasurer, and other officers of the Club subject to the authority of the Committee
	\item generally carry out the policy of the Club
	\item generally carry out the instructions and decisions of the Committee
\end{enumerate}

{\color{red}\subsection{\st{Vice President}}
\st{In addition to any other provisions set out elsewhere in this Constitution, or any regulation or policy made thereunder, it shall be the duty of the Vice-President:}
\begin{enumerate}
	\item \st{To assist in the President's duties;}
	\item \st{To carry out Presidential duties during the absence of the President, during which time the Vice-President shall be deemed to be the President; and}
	\item \st{To generally carry out the instructions of the Committee.}
\end{enumerate}}
...
\begin{enumerate}
	\item maintain an up to date register of the members of the Club and {\color{red}\st{their postal or residential addresses}} {\color{ForestGreen}the information required by the Act} and, upon the request of a member of the Club, make the register available for the inspection of the member
	\begin{enumerate}[1.]
...
\begin{enumerate}
	...
	{\color{ForestGreen} \item assist the other Committee Members in the executions of their duties, especially in the case were they relate to new members
	\item bear any responsibilities that the Committee shall from time to time decide}
\end{enumerate}
...
The Committee may at any time, without the need for a Committee meeting, call a Special General Meeting of the Club by the written agreement of at least {\color{red}\st{4}} {\color{ForestGreen}five} Committee members, at least {\color{red}\st{one}} {\color{ForestGreen}two} of whom is a member of the Executive. This meeting must be notified by the Secretary as with all other General Meetings, or if the Secretary has resigned or is unavailable by any member of the Committee with the same notice requirements of the Secretary.\\
...
\subsection{Chair}
{\color{red}\st{The President shall have the right to take the chair at any General meeting or meetings of the Committee. If the President is absent or does not wish to exercise his right at any meeting, that right shall devolve upon the Vice-President being absent or not wishing to exercise the above right, that meeting shall elect its own Chair.}}\\
...
\begin{enumerate}
	...
	\item The Committee may, outside a Committee meeting, agree to a payment or purchase by written consent of {\color{red}\st{five}} {\color{ForestGreen}six} Committee members including at least {\color{red}\st{two}} {\color{ForestGreen}three} Executive members of the Committee. Such written consent must be tabled and minuted at the next meeting of the Committee.
\end{enumerate}
