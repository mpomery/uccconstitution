...
{\color{ForestGreen}
\subsection{Temporarily Filling Positions}
In the event where an executive role is vacant, the committee may choose to elect a member of the committee to fill that role until a General Meeting is held.
}
\subsection{Election}
